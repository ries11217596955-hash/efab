...
Branch: main
Observed head at generation: 9d171df7f86d340ec11515e1a9e2f85b31220b3d
Generated: 2026-07-07T14:51:00.1640445+04:00
Body source fingerprint: 9fa9efb02e59390622bba196c057542baedbd6713d8c47fdeddd2b324ed923a2
...
- `school_source_router` - PRESENT_ON_CURRENT_BRANCH, root `operations/school/curriculum/source_router`, files=8, scripts=6, required_present=True, latest_runtime=.runtime/school_source_template_filter/school_source_router_filter_school_factory_digest_use_real_1000000_20260707_140233_chunk_20_of_200/SCHOOL_SOURCE_TEMPLATE_FILTER_DECISION_V1.json
- `compact_memory_intake` - PRESENT_ON_CURRENT_BRANCH, root `operations/compact_memory_intake`, files=9, scripts=5, required_present=True, latest_runtime=.runtime/file_atom_absorption/file_atom_absorption_20260707_145049/staging/digestible_atoms.jsonl
- `autonomous_inner_motor` - PRESENT_ON_CURRENT_BRANCH, root `operations/autonomous_inner_motor`, files=64, scripts=3, required_present=True, latest_runtime=.runtime/autonomous_inner_motor/test_life_runs/live_aimo_aimo_growth_selector_hotswap_v1_20260707T104626Z/TEST_LIFE_PROOF.json
- `knowledge_acquisition_port` - PRESENT_ON_CURRENT_BRANCH, root `operations/knowledge_acquisition_port`, files=50, scripts=2, required_present=True, latest_runtime=.runtime/knowledge_acquisition_port/runs/live_aimo_aimo_growth_selector_hotswap_v1_20260707T104626Z_cycle1_batch_knowledge_gap/BATCH_SOURCE_DIGEST_AND_PROMOTION_DECISION.json
