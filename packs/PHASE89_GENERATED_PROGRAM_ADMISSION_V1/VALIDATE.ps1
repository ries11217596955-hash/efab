...
$EntryScript = "packs/PHASE89_GENERATED_PROGRAM_ADMISSION_V1/APPLY.ps1"
$AdmissionPath = "self_build_programs/admission/SELF_BUILD_PROGRAM_001_ADMISSION.json"
$ReportPath = "reports/self_development/GENERATED_PROGRAM_ADMISSION_REPORT.json"
$ProofPath = "proofs/self_development/GENERATED_PROGRAM_ADMISSION_V1.json"
...
foreach ($path in @(
  "contracts/self_development/generated_program_admission.schema.json",
  "modules/self_development/evaluate_generated_program_admission.ps1",
  "packs/PHASE89_GENERATED_PROGRAM_ADMISSION_V1/PACK.json",
  "packs/PHASE89_GENERATED_PROGRAM_ADMISSION_V1/APPLY.ps1",
  "packs/PHASE89_GENERATED_PROGRAM_ADMISSION_V1/VALIDATE.ps1",
...
$generatorReport = Read-JsonFile "reports/self_development/SELF_BUILD_PROGRAM_GENERATOR_REPORT.json"
$generatorProof = Read-JsonFile "proofs/self_development/SELF_BUILD_PROGRAM_GENERATOR_V1.json"
...
if ($Stage -eq "Completed") {
  ...
  if ($null -ne $admission) {
    ...
    if ([bool](Get-PropertyValue -Object $admission -Name "execution_performed")) {
      Add-Failure "ADMISSION_EXECUTION_PERFORMED_TRUE"
    }
  }
...
if (@($script:Failures).Count -gt 0) {
  ...
  throw "PHASE89_VALIDATION_FAILED"
}
