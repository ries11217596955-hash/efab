...
$passportPath='self_model/organ_passports/operations_parallel_life/ORGAN_PASSPORT_V1.json'
...
Assert ($r.status -eq 'PASS_PARALLEL_LIFE_LIFECYCLE_PASS_V1') 'REPORT_STATUS_BAD'
Assert ($proof.status -eq 'PASS_PARALLEL_LIFE_LIFECYCLE_PASS_V1') 'PROOF_STATUS_BAD'
...
Write-Host 'VALIDATION_PASS=PASS_PARALLEL_LIFE_LIFECYCLE_PASS_V1'
