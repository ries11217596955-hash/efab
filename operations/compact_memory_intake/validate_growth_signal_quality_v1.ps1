...
$proof=[ordered]@{
  ...
  tests=@([ordered]@{name='generic_topic_becomes_specificity_gap_contract';status='PASS'},[ordered]@{name='actionable_packet_preserves_specific_contract';status='PASS'},[ordered]@{name='aimo_selector_next_action_static_check';status='PASS'})
