...
Assert ($f.PSObject.Properties.Name -contains 'deep_source_answer_request') 'deep_source_answer_request_field_missing'
Assert ($f.deep_source_answer_request.status -in @('PASS_DEEP_SOURCE_ANSWER_REQUEST_WITH_MEMORY_CANDIDATE_V1','PASS_DEEP_SOURCE_ANSWER_REQUEST_PACKET_V1')) ('deep_source_answer_status_bad:'+ $f.deep_source_answer_request.status)
Assert ($f.deep_source_answer_request.result.answer_contract.required_format -eq 'json_object') 'deep_answer_contract_format_bad'
...
$proof=[ordered]@{
  ...
  correction_deep_source_answer_status=$f.deep_source_answer_request.status
  correction_deep_source_answer_ready=$f.deep_source_answer_request.result.answer_ready
  ...
  tests=@(
    ...
    [ordered]@{name='deep_source_answer_request_has_contract';status=if($f.deep_source_answer_request.result.answer_contract.required_format -eq 'json_object'){'PASS'}else{'FAIL'}},
