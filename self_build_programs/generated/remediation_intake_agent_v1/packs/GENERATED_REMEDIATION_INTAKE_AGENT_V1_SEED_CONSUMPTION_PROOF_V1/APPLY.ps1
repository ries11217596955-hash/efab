...
$Recipe = @'
{
  "recipe_id": "GENERATED_REMEDIATION_INTAKE_AGENT_V1_SEED_CONSUMPTION_PROOF_V1_RECIPE",
  ...
  "pack_id": "GENERATED_REMEDIATION_INTAKE_AGENT_V1_SEED_CONSUMPTION_PROOF_V1",
  ...
  "expected_gate": "GENERATED_REMEDIATION_INTAKE_AGENT_V1_SEED_CONSUMPTION_PROOF_V1",
  ...
  "input_artifacts": {
    ...
    "dependent_generated_profile_proof_path": ".\\proofs\\GENERATED_REMEDIATION_INTAKE_AGENT_V1_PROFILE_MATERIALIZATION_V1.json",
    "dependent_generated_closure_proof_path": ".\\proofs\\GENERATED_REMEDIATION_INTAKE_AGENT_V1_CLOSURE_PROOF_V1.json"
  },
  "invocation_contract": {
  ...
  "expected_assertions": {
    ...
    "cross_proof_consistency_rules": [
      ...
      "closure_proof.specialized_operation == remediation_intake_mode_v1"
    ],
    "expected_specialized_operation": "remediation_intake_mode_v1"
  },
  "proof_contract": {
    "proof_id": "GENERATED_REMEDIATION_INTAKE_AGENT_V1_SEED_CONSUMPTION_PROOF_V1",
    "required_fields": [
      "proof_id",
      "run_id",
      "status",
...
Write-Host "PACK=GENERATED_REMEDIATION_INTAKE_AGENT_V1_SEED_CONSUMPTION_PROOF_V1"
Write-Host "GENERATED_PACK_ROLE=SEED_CONSUMPTION_PROOF"
Write-Host "GENERATED_PACK_TASK=TASK_GENERATED_REMEDIATION_INTAKE_AGENT_V1_SEED_CONSUMPTION_PROOF_V1_001"
