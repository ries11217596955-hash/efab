...
$ProofPath = "tests/accepted_atom_retention/DETACHED_STRUCTURED_CLEANUP_LIFECYCLE_REPAIR_TRIAL_V1.json"
...
Write-Host "VALIDATION_PASS=DETACHED_STRUCTURED_CLEANUP_LIFECYCLE_REPAIR_V1"
