...
## What Belongs Here
Non-trusted reference summaries such as encyclopedic or public explanatory material with provenance.

## What Must Not Be Placed Here
Do not treat reference-only material as runtime authority, trusted code, or production policy.
