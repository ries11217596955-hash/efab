...
$Recipe = @'
{
  "recipe_id": "GENERATED_MONITORING_AGENT_V1_CLOSURE_PROOF_V1_RECIPE",
  ...
  "capability_id": "generated_monitoring_agent_v1_closure_proof_v1",
  "expected_gate": "GENERATED_MONITORING_AGENT_V1_CLOSURE_PROOF_V1",
  ...
  "proof_contract": {
    "proof_id": "GENERATED_MONITORING_AGENT_V1_CLOSURE_PROOF_V1",
    "required_fields": [
      "proof_id",
      "run_id",
      "status",
  ...
  "next_transition": {
    "next_capability_id": "generated_monitoring_agent_v1_seed_consumption_proof_v1",
    "next_task_id": "TASK_GENERATED_MONITORING_AGENT_V1_SEED_CONSUMPTION_PROOF_V1_001",
...
Write-Host "PACK=GENERATED_MONITORING_AGENT_V1_CLOSURE_PROOF_V1"
Write-Host "GENERATED_PACK_ROLE=SPECIALIZED_CLOSURE_PROOF"
Write-Host "GENERATED_PACK_TASK=TASK_GENERATED_MONITORING_AGENT_V1_CLOSURE_PROOF_V1_001"
