...
foreach($needle in @('memory_to_next_path_reuse_gate.json','PASS_MEMORY_TO_NEXT_PATH_REUSE_GATE_V1','Get-LatestMemoryToNextPathReuseGate','-AvoidActionIds $avoidActionIds')){
